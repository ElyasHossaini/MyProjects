...
# Load YOLO file/
net = cv2.dnn.readNet("C:\\Users\\elyas\\Desktop\\Code\\Personal Projects\\espcam-main\\yolov3.weights", "C:\\Users\\elyas\\Desktop\\Code\\Personal Projects\\espcam-main\\yolov3.cfg")
classes = []

# replace with camera URL
#fix this niggggggaaaaaaaaaaaaaaaaaaaa
url='/cam-hi.jpg'

# Load class names from coco file
with open("C:\\Users\\elyas\\Desktop\\Code\\Personal Projects\\espcam-main\\coco.names", "r") as f:
